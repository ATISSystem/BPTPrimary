...
Public Class UCAnnouncedLoadsReport
    Inherits UCGeneral
    ...
    Private Sub UcDateTimeHolder_UCDoCommand() Handles UcDateTimeHolder.UCDoCommand
        Try
            ...
            Else
                Throw New Exception
            End If
            R2CoreGUIMClassInformationManagement.PrintReport(PayanehReports.AnnouncedLoadsReport)
