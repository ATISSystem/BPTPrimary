...
Namespace GeneralConfiguration
    ...
    Public Class R2CoreAPIHelperManager
        ...
        Public Shared APISoftwareUser As HttpClient = Nothing
        ...
        Public Function GetAPISoftwareUser() As HttpClient
            Try
                If APISoftwareUser IsNot Nothing Then Return APISoftwareUser
                Return GetHttpClient("APISoftwareUser")
            Catch ex As FileNotExistException
                Throw ex
            Catch ex As Exception
                Throw New Exception(MethodBase.GetCurrentMethod().ReflectedType.FullName + "." + MethodBase.GetCurrentMethod().Name + ex.Message)
        ...
        Public Function GetAPIKernelTasks() As HttpClient
            Try
                If APISoftwareUser IsNot Nothing Then Return APISoftwareUser
                Return GetHttpClient("APIKernelTasks")
            Catch ex As FileNotExistException
                Throw ex
            Catch ex As Exception
                Throw New Exception(MethodBase.GetCurrentMethod().ReflectedType.FullName + "." + MethodBase.GetCurrentMethod().Name + ex.Message)
    ...
    Public MustInherit Class R2CoreGeneralConfigurations
        ...
        Public Shared ReadOnly Property SoftwareUserTypesPermissions As Int64 = 72
    ...
    Public Class R2CoreGeneralConfigurationManager
        ...
        Public Sub GeneralConfigurationEditing(YourRawGeneralConfiguration As R2CoreRawGeneralConfiguration)
            Dim CmdSql As New SqlClient.SqlCommand
            CmdSql.Connection = R2PrimarySqlConnection.GetTransactionDBConnection
            Try
                CmdSql.Connection.Open()
                CmdSql.Transaction = CmdSql.Connection.BeginTransaction
                CmdSql.CommandText = "Update R2Primary.dbo.TblGeneralConfiguration Set CValue=@CValue Where CId=@CId and CIndex=@CIndex"
                CmdSql.Parameters.Add("@CValue", SqlDbType.NVarChar).Value = YourRawGeneralConfiguration.CValue
                CmdSql.Parameters.Add("@CId", SqlDbType.BigInt).Value = YourRawGeneralConfiguration.CId
                CmdSql.Parameters.Add("@CIndex", SqlDbType.BigInt).Value = YourRawGeneralConfiguration.CIndex
        ...
        Public Function GetBooleanConfiguration(YourCId As Int64, YourCIndex As Int64) As Boolean
            Try
                Return GetConfiguration(YourCId, YourCIndex)
        ...
        Public Function GetStringConfiguration(YourCId As Int64, YourCIndex As Int64) As String
            Try
                Return GetConfiguration(YourCId, YourCIndex)
            Catch ex As DataBaseException
                Throw ex
        ...
        Public Function GetInt64Configuration(YourCId As Int64, YourCIndex As Int64) As Int64
            Try
                Return GetConfiguration(YourCId, YourCIndex)
            Catch ex As DataBaseException
                Throw ex
        ...
        Private Function GetConfiguration(YourCId As Int64, YourCIndex As Int64) As Object
            Try
                Dim DS As DataSet
                InstanceSqlDataBox.GetDataBOX(R2PrimarySqlConnection.GetSubscriptionDBConnection,
                   "Select CValue from R2Primary.dbo.TblGeneralConfiguration Where CId=" & YourCId & " and CIndex=" & YourCIndex & "", 32767, DS, New Boolean)
...
Namespace ConfigurationOfDevices
    ...
    Public MustInherit Class R2CoreConfigurationsOfDevices
        Public Shared ReadOnly Property None As Int64 = 0
        Public Shared ReadOnly Property AttachedPoses As Int64 = 2
    ...
    Public Class R2CoreConfigurationOfDevicesManager
        ...
        Public Sub ConfigurationOfDeviceEditing(YourRawConfigurationOfDevice As R2CoreRawConfigurationOfDevice)
            ...
            Try
                CmdSql.Connection.Open()
                CmdSql.CommandText = "Update R2Primary.dbo.TblConfigurationOfDevices Set CODValue=@CODValue 
                                      Where CODId=@CODId and DeviceId=@DeviceId and CODIndex=@CODIndex"
                CmdSql.Parameters.Add("@CODValue", SqlDbType.NVarChar).Value = YourRawConfigurationOfDevice.CODValue
                CmdSql.Parameters.Add("@CODId", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.CODId
                CmdSql.Parameters.Add("@DeviceId", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.DeviceId
                CmdSql.Parameters.Add("@CODIndex", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.CODIndex
                CmdSql.ExecuteNonQuery()
        ...
        Public Sub ConfigurationOfDeviceRegistering(YourRawConfigurationOfDevice As R2CoreRawConfigurationOfDevice)
            ...
            Try
                ...
                CmdSql.CommandText = "Insert Into R2Primary.dbo.TblConfigurationOfDevices(CODId,CODName,CODTitle,DeviceId,CODIndex,CODIndexTitle,Description,CODValue,Template,Active)
                                      Values(@CODId,@CODName,@CODTitle,@DeviceId,@CODIndex,@CODIndexTitle,@Description,@CODValue,0,1)"
                CmdSql.Parameters.Add("@CODId", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.CODId
                CmdSql.Parameters.Add("@CODName", SqlDbType.NVarChar).Value = YourRawConfigurationOfDevice.CODName
                CmdSql.Parameters.Add("@CODTitle", SqlDbType.NVarChar).Value = YourRawConfigurationOfDevice.CODTitle
                CmdSql.Parameters.Add("@DeviceId", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.DeviceId
                CmdSql.Parameters.Add("@CODIndex", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.CODIndex
                CmdSql.Parameters.Add("@CODIndexTitle", SqlDbType.NVarChar).Value = YourRawConfigurationOfDevice.CODIndexTitle
                CmdSql.Parameters.Add("@Description", SqlDbType.NVarChar).Value = YourRawConfigurationOfDevice.Description
                CmdSql.Parameters.Add("@CODValue", SqlDbType.NVarChar).Value = YourRawConfigurationOfDevice.CODValue
                CmdSql.ExecuteNonQuery()
                CmdSql.Connection.Close()
            Catch ex As SqlException
        ...
        Public Sub ConfigurationOfDeviceDeleting(YourRawConfigurationOfDevice As R2CoreRawConfigurationOfDevice)
            ...
            Try
                CmdSql.Connection.Open()
                CmdSql.CommandText = "Delete R2Primary.dbo.TblConfigurationOfDevices Where CODId=@CODId and CODIndex=@CODIndex and DeviceId=@DeviceId"
                CmdSql.Parameters.Add("@CODId", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.CODId
                CmdSql.Parameters.Add("@CODIndex", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.CODIndex
                CmdSql.Parameters.Add("@DeviceId", SqlDbType.BigInt).Value = YourRawConfigurationOfDevice.DeviceId
                CmdSql.ExecuteNonQuery()
        ...
        Public Function GetBooleanConfiguration(YourCODId As Int64, YourDeviceId As Int64, YourCODIndex As Int64) As Boolean
            Try
                Return GetConfiguration(YourCODId, YourDeviceId, YourCODIndex)
            Catch ex As FileNotExistException
                Throw ex
            Catch ex As Exception
                Throw New Exception(MethodBase.GetCurrentMethod().ReflectedType.FullName + "." + MethodBase.GetCurrentMethod().Name + vbCrLf + ex.Message)
        ...
        Public Function GetInt32Configuration(YourCODId As Int64, YourDeviceId As Int64, YourCODIndex As Int64) As Int32
            Try
                Return GetConfiguration(YourCODId, YourDeviceId, YourCODIndex)
            Catch ex As FileNotExistException
                Throw ex
        ...
        Public Function GetInt64Configuration(YourCODId As Int64, YourDeviceId As Int64, YourCODIndex As Int64) As Int64
            Try
                Return GetConfiguration(YourCODId, YourDeviceId, YourCODIndex)
            Catch ex As FileNotExistException
                Throw ex
        ...
        Public Function GetStringConfiguration(YourCODId As Int64, YourDeviceId As Int64, YourCODIndex As Int64) As String
            Try
                Return GetConfiguration(YourCODId, YourDeviceId, YourCODIndex)
            Catch ex As FileNotExistException
                Throw ex
        ...
        Private Function GetConfiguration(YourCODId As Int64, YourDeviceId As Int64, YourCODIndex As Int64) As Object
            Try
                Dim DS As DataSet
                InstanceSqlDataBox.GetDataBOX(R2PrimarySqlConnection.GetSubscriptionDBConnection,
                   "Select CODValue from R2Primary.dbo.TblConfigurationOfDevices Where CODId=" & YourCODId & " and DeviceId=" & YourDeviceId & " and CODIndex=" & YourCODIndex & "", 32767, DS, New Boolean)
                Return DS.Tables(0).Rows(0).Item("CODValue")
            Catch ex As FileNotExistException
                Throw ex
            Catch ex As Exception
                Throw New Exception(MethodBase.GetCurrentMethod().ReflectedType.FullName + "." + MethodBase.GetCurrentMethod().Name + vbCrLf + ex.Message)
...
Namespace ConfigurationManagement_Old
    ...
    Public MustInherit Class R2CoreConfigurations
        ...
        'Public Shared ReadOnly Property SoftwareUserTypesPermissions As Int64 = 72
        Public Shared ReadOnly Property xxxx As Int64 = 73
    ...
    '    'Private Function GetConfig(YourCId As Int64, YourIndex As Int64) As Object
    '    '    Try
    '    '        Dim Ds As DataSet
