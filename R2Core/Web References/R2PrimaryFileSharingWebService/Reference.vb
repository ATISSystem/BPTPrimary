...
'
Namespace R2PrimaryFileSharingWebService
    ...
    Partial Public Class R2PrimaryFileSharingWebService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.R2Core.My.MySettings.Default.R2Core_R2PrimaryFileSharingWebService_R2PrimaryFileSharingWebService
