...
Namespace RFIDCardsManagement
    ...
    '                Dim InavidRFIDCards As String() = InstanceGeneralConfiguration.GetStringConfiguration(R2CoreGeneralConfigurations.InvalidRFIDCards, 0).Split("-")
    ...
    '                    Else
    '                        ReaderTimer.Start()
    '                        _Requester.R2RFIDCardReaderWarning(InstanceGeneralConfiguration.GetStringConfiguration(R2CoreGeneralConfigurations.RFIDCardNotConfirmMessage, 0))
    '                    End If
    '                Else
    '                    _Requester.R2RFIDCardReaded(_CurrentCardNo)
    '                    Exit Sub
