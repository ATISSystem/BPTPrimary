...
Namespace Traffic
    ...
    Public Class R2CoreParkingSystemTrafficManager
        ...
        Public Function GetTrafficRecords(YourTrafficCardId As Int64) As String
            Try
                ...
                InstanceSqlDataBOX.GetDataBOX(R2PrimarySqlConnection.GetSubscriptionDBConnection,
                   "Select EntryExitId,EntryShamsiDate,EntryTime,EntryTrafficCards.CardNo as EntryTrafficCardNo,EntrySoftwareUsers.UserName as EntrySoftwareUser,EntryCost,EntryTrafficGates.GateTitle as EntryGateTitle ,
                    ...
                    Where EntryTrafficCardId=" & YourTrafficCardId & " Order By EntryDateTimeMilladi for JSON PATH", 32727, DS, New Boolean)
