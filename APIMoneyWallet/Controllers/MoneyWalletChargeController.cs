...
namespace APIMoneyWalletAndTraffic.Controllers
{
    ...
    public class MoneyWalletChargeController : ApiController
    {
        ...
        public HttpResponseMessage PaymentRequest([FromBody] APIMoneyWalletSessionIdAmount Content)
        {
            try
            {
        ...
        public HttpResponseMessage GetDefaultAmounts([FromBody] APICommonSessionId Content)
        {
            try
            {
                ...
                HttpResponseMessage response = new HttpResponseMessage(HttpStatusCode.OK);
                response.Content = new StringContent(InstanceMoneyWalletCharge.GetDefaultAmounts(false), Encoding.UTF8, "application/json");
                return response;
            }
            catch (PaymentWebServiceConnectingException ex)
            { return _APICommon.CreateErrorContentMessage(ex); }
        ...
        public HttpResponseMessage GetMoneyWalletChargeRecords([FromBody] APIMoneyWalletSessionIdMoneyWalletId Content)
        {
            try
            {
                var InstanceSession = new R2CoreSessionManager();
                ...
                HttpResponseMessage response = new HttpResponseMessage(HttpStatusCode.OK);
                response.Content = new StringContent(InstanceMoneyWalletCharge.GetMoneyWalletChargeRecords(MoneyWalletId,false), Encoding.UTF8, "application/json");
                return response;
            }
            catch (PaymentWebServiceConnectingException ex)
            { return _APICommon.CreateErrorContentMessage(ex); }
        ...
        public HttpResponseMessage GetTotalAmountofUserFunction([FromBody] APIMoneyWalletSessionIdDateTime Content)
        {
            try
            {
                var InstanceSession = new R2CoreSessionManager();
        ...
        public HttpResponseMessage GetUserChargingFunction([FromBody] APIMoneyWalletSessionIdDateTime Content)
        {
            try
            {
                var InstanceSession = new R2CoreSessionManager();
