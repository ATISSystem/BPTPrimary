    ...
    public class MoneyWalletController : ApiController
    {
        ...
        public HttpResponseMessage GetUserMoneyWallet([FromBody] APICommonSessionId Content)
        {
            try
            {
                ...
                response.Content = new StringContent(JsonConvert.SerializeObject(InstanceMoneyWallet.GetMoneyWallet(User,false )), Encoding.UTF8, "application/json");
                return response;
            }
        ...
        public HttpResponseMessage GetMoneyWalletBalance([FromBody] APIMoneyWalletSessionIdMoneyWalletId Content)
        {
            try
            {
                var InstanceSession = new R2CoreSessionManager();
        ...
        public HttpResponseMessage GetMoneyWalletTransactions([FromBody] APIMoneyWalletSessionIdMoneyWalletId Content)
        {
            try
            {
                var InstanceSession = new R2CoreSessionManager();
        ...
        public HttpResponseMessage GetTruckMoneyWallet([FromBody] APIMoneyWalletSessionIdTruckId Content)
        {
            try
            {
                var InstanceMoneyWallet = new R2CoreParkingSystemMoneyWalletManager(_DateTimeService);
        ...
        public HttpResponseMessage GetTransportCompanyMoneyWallet([FromBody] APIMoneyWalletSessionIdTransportCompanyId Content)
        {
            try
            {
                var InstanceMoneyWallet = new R2CoreParkingSystemMoneyWalletManager(_DateTimeService);
                ...
                HttpResponseMessage response = new HttpResponseMessage(HttpStatusCode.OK);
                response.Content = new StringContent(JsonConvert.SerializeObject(InstanceMoneyWallet.GetMoneyWalletfromTransportCompanyId(TruckId,true )), Encoding.UTF8, "application/json");
                return response;
            }
            catch (DataBaseException ex)
            { return _APICommon.CreateErrorContentMessage(ex); }
