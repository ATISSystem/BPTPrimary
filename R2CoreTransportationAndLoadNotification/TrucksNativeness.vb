...
Namespace TrucksNativeness
    ...
    Public Structure R2CoreTransportationAndLoadNotificationsTruckNativenessStructure
        ...
        Dim TruckNativenessExpireDate As R2CoreDateAndTime
    End Structure
    ...
    Public Class R2CoreTransportationAndLoadNotificationsTruckNativenessManager
        ...
        Public Function ChangeTruckNativeness(YourTruckId As Int64, YourTruckNativenessExpireDate As String) As R2CoreTransportationAndLoadNotificationsTruckNativenessExtendedStructure
            ...
            Try
                ...
                CmdSql.CommandText = "Update dbtransport.dbo.TbCar Set CarNativenessTypeId=@CarNativenessTypeId,CarNativenessExpireDate=@CarNativenessExpireDate Where nIdCar=@nIdCar"
                CmdSql.Parameters.Add("@CarNativenessTypeId", SqlDbType.Int).Value = newTruckNativenessTypeId
                CmdSql.Parameters.Add("@CarNativenessExpireDate", SqlDbType.NVarChar).Value = YourTruckNativenessExpireDate
                CmdSql.Parameters.Add("@nIdCar", SqlDbType.BigInt).Value = NSSTruck.NSSCar.nIdCar
        ...
        Public Function IsTruckIndigenous(YourTruck As R2CoreTransportationAndLoadNotificationTruck) As Boolean
            Try
                ...
                InstanceSQLInjectionPrevention.GeneralAuthorization(YourTruck.Pelak)
                InstanceSQLInjectionPrevention.GeneralAuthorization(YourTruck.Serial)
        ...
        Public Function GetTruckNativenessTypes(YourImmediately As Boolean) As String
            Try
                ...
                If YourImmediately Then
                    Dim Da As New SqlClient.SqlDataAdapter
                    Da.SelectCommand = New SqlCommand(
                        "Select NId as TruckNativenessTypeId,NTItle as TruckNativenessTypeTitle 
                         from R2PrimaryTransportationAndLoadNotification.dbo.TblTruckNativenessTypes 
                         Where Active=1 Order By NId for Json Path")
                    Da.SelectCommand.Connection = R2PrimarySqlConnection.GetSubscriptionDBConnection
                ...
                Else
                    If InstanceSqlDataBox.GetDataBOX(R2PrimarySqlConnection.GetSubscriptionDBConnection,
                        "Select NId as TruckNativenessTypeId,NTItle as TruckNativenessTypeTitle 
                         from R2PrimaryTransportationAndLoadNotification.dbo.TblTruckNativenessTypes 
                         Where Active=1 Order By NId for Json Path", 32767, Ds, New Boolean).GetRecordsCount = 0 Then Throw New AnyNotFoundException
                End If
