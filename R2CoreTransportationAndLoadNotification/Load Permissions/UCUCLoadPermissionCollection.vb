...
Public Class UCUCLoadPermissionCollection
...
#Region "Subroutins And Functions"
    ...
    Private Lst As List(Of R2CoreTransportationAndLoadNotificationStandardLoadPermissionExtendedStructure)
    Private _Counting As Int64
    Private _Counter As Int64
    Public Sub UCViewCollection(YourCollection As List(Of R2CoreTransportationAndLoadNotificationStandardLoadPermissionExtendedStructure))
        Try
            UCRefresh()
            Lst = YourCollection
    ...
    Private Sub UCViewCollection()
        Try
            ...
            Dim UC As UCViewerNSSLoadPermissionExtended = New UCViewerNSSLoadPermissionExtended()
...
#Region "Event Handlers"
    ...
    Private Sub UCs_UCClickedEvent(UC As UCLoadPermission)
        Try
