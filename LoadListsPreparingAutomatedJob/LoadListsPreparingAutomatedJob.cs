            ...
            try
            {
                ...
                while (_FailStatus)
                {
                    try
                    {
                        ...
                        _AutomatedJobsTimer.Interval = InstanceGeneralConfiguration.GetInt64Configuration(R2CoreTransportationAndLoadNotificationGeneralConfigurations.LoadListsPreparingAutomatedJob, 0) * 1000;
                        _FailStatus = false;
