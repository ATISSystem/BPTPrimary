    ...
    public class TruckDriverController : ApiController
    {
        ...
        public HttpResponseMessage GetTruckDriverfromRMTO()
        {
            try
            {
                ...
                var TruckDriver = _WS.WebMethodGetDriverTruckByNationalCodefromRMTO(TruckDriverNationalCode, _WS.WebMethodLogin(InstanceSoftwareUsers.GetNSSSystemUser().UserShenaseh, InstanceSoftwareUsers.GetNSSSystemUser().UserPassword));
        ...
        public HttpResponseMessage ActivateSMSOwner()
        {
            try
            {
                ...
                InstanceSMSOwners.ActivateSMSOwner(InstanceTruckDrivers.GetSoftwareUserIdfromTruckDriverId(TruckDriverId), UserId);
